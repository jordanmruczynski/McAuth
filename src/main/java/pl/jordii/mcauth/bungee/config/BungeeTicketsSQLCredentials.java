...
@Singleton
public class BungeeTicketsSQLCredentials extends MySQLCredentials {
    ...
    @Inject
    public BungeeTicketsSQLCredentials(McAuthBungee plugin) {
        this.file = new File("plugins//" + plugin.getDescription().getName(), "ticketsSql.yml");
